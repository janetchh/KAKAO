		...
		<div class="maindiv" align="center">
			...
			%>
				<div class="gallery" style="height: 100%;">
					<a href="productInfo.jsp?prono=<%=bean.getProno()%>"> <img src="/KAKAO/img/인형/<%=bean.getMainimg() %>" width="600" height="400" >
					...
					<a href="cartList.jsp?job=add&prono=<%=bean.getProno()%>&count=1"><button type="button" class="btn btn-info">장바구니</button></a>
