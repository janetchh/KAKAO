  ...
  <jsp:include page="header.jsp" />
     ...
     <div class="wrap">
    	...
    	<table>
	    	...
	    	<td> 금액 : <label class=" " style="font-size: 13pt; font-weight:normal; margin-right: 10px;"><%=productBean.getPrice()*productBean.getCount() %></label>원
	    	...
	    	<td><button type="button" id="mod" class="btn btn-info" style="margin-bottom: 5px; margin-right: 10px;">변경</button> </td>
