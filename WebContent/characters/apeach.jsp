...
<body>
	...
	<%
		...
		List<ProductBean> list = dao.selectCharacterList("어피치");
	%>

	<!--타이틀IMG  -->
	 <img alt="electronicmain" src="/KAKAO/img/apeach.jpg" style="width: 100%; height: 80%;"> 
		...
		<div class="maindiv" align="center">
			...
			%>
				<div class="gallery" style="height: 100%;">
					<a href="../main/productInfo.jsp?prono=<%=bean.getProno()%>"> <img src="/KAKAO/img/<%=bean.getType() %>/<%=bean.getSubtype() %>/<%=bean.getMainimg() %>" width="600" height="400" >
