		...
		<div class="maindiv" align="center">
			...
			<form action="/KAKAO/main/order.jsp" method="get" >		
				...
				<div class="gallery" style="height: 100%;">
					...
					<input type="hidden" name="picture" value="/KAKAO/img/문구/<%=bean.getMainimg()%>"> 
					...
					%>
						<a href="/KAKAO/category/stationery.jsp?job=wish&prono=<%=bean.getProno()%>"><button type="button" class="btn btn-info" id="wishBtn">찜하기</button></a>
